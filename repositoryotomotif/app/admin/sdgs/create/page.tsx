            ...
            <div className="mx-auto max-w-2xl">
                <div className="mb-8">
                    ...
                    <p className="mt-2 text-gray-600">
                        Tambahkan Sustainable Development Goal baru ke repository. Gambar logo bersifat opsional.
                    </p>
                </div>
                    ...
                    <form onSubmit={handleSubmit} className="space-y-6">
                        ...
                        <div>
                            ...
                            <textarea
                                ...
                                rows={4}
                                placeholder="Masukkan deskripsi SDG..."
                                className="w-full rounded-lg border border-gray-300 px-4 py-3 outline-none transition focus:border-blue-500 focus:ring-2 focus:ring-blue-100"
                            />
                        </div>

                        {/* Upload Gambar Logo (Opsional) */}
                        <div>
                            ...
                            <div className="flex items-center gap-4">
                                {imagePreview ? (
                                    ...
                                    <div className="flex h-24 w-24 items-center justify-center rounded-lg border-2 border-dashed border-gray-300 bg-gray-50 text-gray-400">
                                        <span className="text-xs text-center px-1">Belum ada gambar</span>
                                    </div>
                                )}
                                ...
                                <div className="flex-1">
                                    ...
                                    <p className="mt-1 text-xs text-gray-500">
                                        Format: PNG, JPG, WEBP, atau SVG (Maks. 5MB). Kosongkan jika tidak ada.
                                    </p>
                                </div>
                            </div>
                        </div>
